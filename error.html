...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                ...
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Page</a>
                                                        <ul>
                                                            ...
                                                            <li class="current"><a href="error.html">Error</a></li>
            ...
            <section class="flat-error center " >
                <div class="container"> 
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="images">
                            ...
                            <div class="heading-sections center">
                                <h2>Oh no... We lost this page</h2>
                                <p class="text-color-2">We searched everywhere but couldn’t find what you’re looking for.
                                    Let’s find a better place for you to go.</p>
                                <div class="button-error center">
                                    <a class="sc-button" href="index.html">                             
