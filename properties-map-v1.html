...
<body class="body ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
            ...
            <!-- Main Header -->
            <header class="main-header style-header">
                <!-- Header Lower -->
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Property</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Property Map</a>
                                                                <ul>
                                                                    <li class="current"><a href="properties-map-v1.html">Property Half Map V1</a></li>
            ...
            <div class=" wrap-map flat-featured  flat-property style flex">
                <div class="content-left wg-dream">
                    ...
                    <div class="wrap-item form-wg flex-wrap flex ">
                        <div class="box box-dream hv-one style-dream wg-box">
                            ...
                            <div class="content">
                                ...
                                <div class="days-box flex justify-space align-center">
                                    ...
                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="assets/images/author/author-20.jpg" alt="images"></div>
                        ...
                        <div class="box box-dream hv-one style-dream wg-box">
                            ...
                            <div class="content">
                                ...
                                <div class="days-box flex justify-space align-center">
                                    <a class="compare flex align-center fw-6" href="#">Compare</a>
                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="assets/images/author/author-21.jpg" alt="images"></div>
                                    <div class="days">3 years ago</div>
                                </div>                                           
                            </div>
                        </div>
                        <div class="box box-dream hv-one style-dream wg-box" >
                            <div class="image-group relative ">
                                ...
                                <div class="swiper-container noo carousel-2 img-style" >    
                                    <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                    <div class="swiper-wrapper ">
                                        <div class="swiper-slide"><img src="assets/images/house/featured-43.jpg" alt="images"></div>
                        ...
                        <div class="box box-dream hv-one style-dream wg-box" >
                            <div class="image-group relative ">
                                ...
                                <div class="swiper-container noo carousel-2 img-style" >    
                                    <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                    <div class="swiper-wrapper ">
                                        <div class="swiper-slide"><img src="assets/images/house/featured-44.jpg" alt="images"></div>
                    ...
                    <div class="themesflat-pagination clearfix center">
                        <ul>
                            <li><a class="page-numbers style"><i class="far fa-angle-left"></i></a></li>
                ...
                <div class="content-right fixed-space po-sticky">
