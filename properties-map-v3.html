...
<body class="body ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
            ...
            <!-- Main Header -->
            <header class="main-header style-header header header-default" id="header" >
                <!-- Header Lower -->
                                                ...
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Property</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Property Map</a>
                                                                <ul>
                                                                    <li><a href="properties-map-v1.html">Property Half Map V1</a></li>
                                                                    <li><a href="properties-map-v2.html">Property Half Map V2</a></li>
                                                                    <li class="current"><a href="properties-map-v3.html">Property Half Map V3</a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                    </li>
            ...
            <div class=" wrap-map3 flat-property flat-property-list2  style flex">
                <div class="content-left wg-dream relative">
                    ...
                    <div class="wrap-list">
                        <div class="box box-dream ">
                            <div class="image-group relative flex">
                                <div class="img-box img-box1 relative">
                                ...
                                <div  class="img-box img-box2">
                                    <img class="img-2" src="assets/images/house/property-listing-map-2.jpg" alt="images">
                                    <img src="assets/images/house/property-listing-map-3.jpg" alt="images">
                                </div>
                                <div  class="img-box img-box3">
                                    <img class="img-3" src="assets/images/house/property-listing-map-4.jpg" alt="images">
                            ...
                            <div class="content relative">
                                ...
                                <a class="icon-d icon-book">
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.2626 1.93781C10.9042 2.01247 11.375 2.56606 11.375 3.21239V12.25L7 10.0625L2.625 12.25V3.21239C2.625 2.56606 3.09517 2.01247 3.73742 1.93781C5.90519 1.68618 8.09481 1.68618 10.2626 1.93781V1.93781Z" stroke="#FFA920" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                    <!-- <i class="far fa-bookmark"></i> -->
                                </a>  
                                <a class="icon-d icon-repeat">
                        ...
                        <div class="box box-dream ">
                            <div class="image-group relative flex">
                                ...
                                <div  class="img-box img-box2">
                                    <img class="img-2" src="assets/images/house/property-listing-map-7.jpg" alt="images">
                                    <img src="assets/images/house/property-listing-map-8.jpg" alt="images">
                                </div>
                                <div  class="img-box img-box3">
                                    <img class="img-3" src="assets/images/house/property-listing-map-9.jpg" alt="images">
                                    <div class="icon-inner center relative">
                                        <div class="imgs">
                        ...
                        <div class="box box-dream ">
                            <div class="image-group relative flex">
                                ...
                                <div  class="img-box img-box2">
                                    <img class="img-2" src="assets/images/house/property-listing-map-12.jpg" alt="images">
                                    <img src="assets/images/house/property-listing-map-13.jpg" alt="images">
                                </div>
                                <div  class="img-box img-box3">
                                    <img class="img-3" src="assets/images/house/property-listing-map-14.jpg" alt="images">
                                    <div class="icon-inner center relative">
                                        <div class="imgs">
            ...
            <section class="flat-contact2 relative style" >
                <div class="container">
                    <div class="row">                      
                        <div class="col-lg-12">
