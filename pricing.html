...
<body class="body  counter-scroll">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
            ...
            <section class="flat-pricing page">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box box-style">
                                ...
                                <div class="title-price flex">
                                    <h2>$19 </h2><div class="mo fw-4 fs-30 fw-7"> / mo</div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box box-style active">
                                ...
                                <p class="text-sub fw-6 ">Automatically reach potential customers</p>
                                <div class="title-price flex">
                                    <h2>$87</h2><div class="mo fw-4 fs-30 fw-7">/ mo</div>
                                </div>
                                <p class="texts">Per month, per company or team members</p>
                                <ul class="check">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box box-style">
                                ...
                                <p class="text-sub fw-6">Automatically reach potential customers</p>
                                <div class="title-price flex">
                                    <h2>$120</h2><div class="mo fw-4 fs-30 fw-7">/ mo</div>
                                </div>
                                <p class="texts">Per month, per company or team members</p>
                                <ul class="check">
                                    <li class="flex-three">Listing free</li>
            ...
            <section class="flat-faq flat-accordion fl-faq-content page" >
                <div class="container">
                    <div class="row">    
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                <h2>Frequently asked questions</h2>
                                <div class="text-box flex justify-center flex-wrap"><span class="text-color-4">Quick answers to questions you may have. Can't find what you're looking for? Check out our </span><a class="fw-7 font-2 text-color-4 text-line"> full documentation</a></div>
                            </div>
                        </div>                  
                        <div class="col-lg-6">
