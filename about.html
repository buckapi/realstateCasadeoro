...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                    ...
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="title-inner style">
                                <div class="title-group fs-12"><a class="home fw-6 text-color-3" href="index.html">Home</a><span >About</span></div>
                            </div>
                        </div> 
                    </div>
                </div>
                    ...
                    <div class="row">                      
                        <div class="col-lg-7 col-md-7">
                            <div class="heading-about">
                                ...
                                <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Egestas vitae auctor in gravida tellus vestibulum faucibus in ut. Dolor bibendum suspendisse vestibulum ullamcorper morbi morbi vulputate.</h4>
                                <p class="text-1 text-color-2">Donec bibendum nibh quis nisl luctus, at aliquet ipsum bibendum. Fusce at dui tincidunt nulla semper venenatis at et magna. Mauris turpis lorem, ultricies vel justo sed, ultrices auctor nisi. </p>
                                <div class="text-box">
                                    <p class="font-2 fw-5 font-italic text-color-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse auctor, mi euismod dignissim scelerisque, eros augue vehicula lectus, quis vestibulum enim augue ut est</p>
                                </div>
                                <div class="author-box">
                                    <h3>Ralph Edwards</h3>
                                    <p>CEO & Co-Founder</p>
                                    <img src="assets/images/img-box/about-signature.png" alt="images"> 
                                </div>
                            </div>
                            <div class="icon-box icon-box2 center">
                                <img src="assets/images/icon/about-2.png" alt="images"> 
                                <div class="title-icon fw-8 fs-40 font-2 relative">87%</div>
                                <h5>sales rate</h5>
                            </div>
                            <div class="icon-box center">
                                <img src="assets/images/icon/about-1.png" alt="images"> 
                                <div class="title-icon fw-8 fs-26 font-2 relative">975K</div>
                                <h5>Listing</h5>
                            </div>
                        </div>  
                        <div class="col-lg-5 col-md-5">
                            <div class="video-box center">
                                <div class="post-video flex-five">      
                                    <img class="img-2" src="assets/images/img-box/about-video.jpg" alt="images">                       
                    ...
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                ...
                                <p class="text-1 text-color-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer vel lobortis justo</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box">
                                ...
                                <p class="text-color-2">condimentum id. Nulla congue nunc vitae odio dictum, euismod mattis eros dapibus</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box">
                                ...
                                <p class="text-color-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque faucibus pretium risus at commodo. </p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box">
                                ...
                                <p class="text-color-2">Nulla facilisi. Praesent vulputate mollis ante feugiat mattis. Vestibulum felis nunc, faucibus ac varius eget, tempor</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="flat-why-choose page" >
                <div class="container">
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                <h2>Why choose us</h2>
                                <p class="text-color-4">Save your time and effort with our tools</p>
                            </div>
                            <div class="wrap-why-choose flex">
                                <div class="box center hv-one">
                                    ...
                                    <h4 class="link-style-1"><a href="#">Thousands of posts every day</a></h4>
                                    <div class="images img-style relative"><img src="assets/images/img-box/why-choose-1.jpg" alt="images"></div>
                                    <p class="text-color-2">The lists are always refreshed and updated constantly, you will never miss</p>
                                    <div class="meta style">
                                        <a href="#" class="btn-button flex align-center justify-center fs-13 fw-6 text-color-2"><span>See all listings</span> 
                                ...
                                <div class="box center hv-one">
                                    ...
                                    <h4 class="link-style-1"><a href="#">Smart filter</a></h4>
                                    <div class="images img-style relative"><img src="assets/images/img-box/why-choose-2.jpg" alt="images"></div>
                                    <p class="text-color-2">Find the right house for you in the shortest amount of time</p>
                                    <div class="meta style">
                                        <a href="#" class="btn-button flex align-center justify-center fs-13 fw-6 text-color-2"><span>See all listings</span> 
                                            <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0.875 6H12.125M12.125 6L7.0625 0.9375M12.125 6L7.0625 11.0625" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <div class="box center hv-one">
                                    ...
                                    <h4 class="link-style-1"><a href="#">Great support</a></h4>
                                    <div class="images img-style relative"><img src="assets/images/img-box/why-choose-3.jpg" alt="images"></div>
                                    <p class="text-color-2">After-sales care service, helpful advice to avoid scams</p>
                                    <div class="meta style">
                                        <a href="#" class="btn-button flex align-center justify-center fs-13 fw-6 text-color-2"><span>See all listings</span> 
                                            <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0.875 6H12.125M12.125 6L7.0625 0.9375M12.125 6L7.0625 11.0625" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <section class="flat-search-home page" >
                <div class="container">
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                <h2 class="fw-8 font-2 lh-56">We provide the most suitable and quality real estate.</h2>
                                <p class="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sed tristique metus proin id lorem odio</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon flex align-center">
                                ...
                                <div class="content">
                                    <p class="text-1 fw-6">Office address</p>
                                    <div class="fs-16 lh-24">2715 Ash Dr. San Jose, South Dakota 83475</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon flex align-center">
                                ...
                                <div class="content">
                                    <p class="text-3  fw-6">Email us</p>
                                    <a href="mailto:hellosupport@gmail.com"><div class="fs-16">hellosupport@gmail.com</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <form method="post" id="contactform" class="comment-form form-submit"
                                        ...
                                        <div class="text-wrap flex form-wg">
                                            <fieldset class="info-box">
                                                ...
                                                <input type="text" class="tb-my-input" name="text" placeholder="Your name" required="">
                                            </fieldset>
                                            <fieldset class="info-box">
                                                <label class="fw-6">Email or phone</label>
                                                <input type="email" class="tb-my-input" name="email" placeholder="Email or phone number" required="">
                                            </fieldset>
                                            <div class="info-box">
            ...
            <section class="flat-meet page-about" >
                <div class="container">
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="agents-detail.html"><img src="assets/images/img-box/meet-4.jpg" alt="images"></a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="agents-detail.html"><img src="assets/images/img-box/meet-5.jpg" alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                                        <a href="#"><i class="fab fa-linkedin-in"></i></a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="agents-detail.html"><img src="assets/images/img-box/meet-6.jpg" alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                                        <a href="#"><i class="fab fa-linkedin-in"></i></a>
