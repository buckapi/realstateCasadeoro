...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix"> 
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Property Grid</a>
                                                                <ul>
                                                                    ...
                                                                    <li class="current"><a href="properties-grid-sidebar-v2.html">Property Grid Sidebar V2</a></li>
                                                                </ul>
                                                            </li>
            ...
            <!-- title page -->
            <section class="flat-title-page inner style"> <div class="overlay2"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <section class="flat-featured flat-property flat-property-grid-2 tf-section2 wg-dream style" >
                <div class="container">
                    <div class="row">                      
                        <div class="col-lg-8">
                            <div class="post">
                                ...
                                <div class="themesflat-pagination clearfix style2">
                                    <ul>
