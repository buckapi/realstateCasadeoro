...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                        ...
                                                        <ul>
                                                            <li class="dropdown2 current"><a href="#">Property List</a>
                                                                <ul>
                                                                    ...
                                                                    <li class="current"><a href="properties-list-sidebar-v1.html">Property List Sidebar V1</a></li>
            ...
            <!-- title page -->
            <section class="flat-title-page inner style3"> <div class="overlay2"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="box box-dream flex hv-one">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="img-box flex justify-space align-center">
                                            ...
                                            <div class="img-author flex align-center"><img src="assets/images/author/author-list-6.jpg" alt="images"><div class="fs-13 fw-6 link-style-1"><a href="#">Kathryn Murphy</a></div> </div>
                                            <a class="icon-repeat">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M5 14L2 11M2 11L5 8M2 11H11M11 2L14 5M14 5L11 8M14 5H5" stroke="#1C1C1E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                ...
                                <div class="box box-dream flex hv-one">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="img-box flex justify-space align-center">
                                            ...
                                            <div class="img-author flex align-center"><img src="assets/images/author/author-list-7.jpg" alt="images"><div class="fs-13 fw-6 link-style-1"><a href="#">Kathryn Murphy</a></div> </div>
                                            <a class="icon-repeat">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M5 14L2 11M2 11L5 8M2 11H11M11 2L14 5M14 5L11 8M14 5H5" stroke="#1C1C1E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                                    ...
                                                    <div class="form-s2">
                                                        <form method="post">
                                                          ...
                                                          <div class="wd-find-select ">
                                                            ...
                                                            <div class="form-group-4 form-style2">
                                                                <div class="group-select">
                                                              ...
                                                              <div class="form-group-5 form-style2">
                                                                <div class="group-select">
                                                              ...
                                                              <div class="price-group style-group">
                                                                <h4>Price</h4>
                                                                <div class="inner flex flex-wrap">
                                                                    <div class="group-select">
                                                                        <div class="nice-select" tabindex="0"><span class="current">Min</span>
                                                                            <ul class="list">                                                          
                                                                                <li data-value class="option selected">Min</li>
                                                                                <li data-value="0" class="option">0</li>
                                                                                <li data-value="100" class="option">$100</li>
                                                                                <li data-value="300" class="option">$300</li>                                                                  
                                                                                <li data-value="500" class="option">$500</li>
                                                                                <li data-value="700" class="option">$700</li>
                                                                                <li data-value="1000" class="option">$1,000</li>                                                                  
                                                                                <li data-value="1300" class="option">$1,300</li>
                                                                                <li data-value="1500" class="option">$1,500</li>
                                                                                <li data-value="1700" class="option">$1,700</li>                                                                  
                                                                                <li data-value="2000" class="option">$2,000</li>
                                                                              </ul>
                                                                        </div>
                                                                    </div>
                                                                    <div class="group-select">
                                                                        <div class="nice-select" tabindex="0"><span class="current">Max</span>
                                                                            <ul class="list">                                                          
                                                                                <li data-value class="option selected">Max</li>
                                                                                <li data-value="200" class="option">$200</li>
                                                                                <li data-value="400" class="option">$400</li>                                                                  
                                                                                <li data-value="600" class="option">$600</li>
                                                                                <li data-value="800" class="option">$800</li>
                                                                                <li data-value="1100" class="option">$1,100</li>                                                                  
                                                                                <li data-value="1400" class="option">$1,400</li>
                                                                                <li data-value="1600" class="option">$1,600</li>
                                                                                <li data-value="1800" class="option">$1,800</li>                                                                  
                                                                                <li data-value="2200" class="option">$2,200</li>
                                                                              </ul>
                                                                        </div>
                                                                    </div>  
                                                                </div>
                                                              </div>
                                                              <div class="area-group style-group">
                                                                <h4>Area</h4>
                                                                <div class="inner flex flex-wrap">
                                                                    <div class="group-select">
                                                                        <div class="nice-select" tabindex="0"><span class="current">Min</span>
