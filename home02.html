...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                ...
                                <div class="icon-tell-box flex align-center">
                                    <div class="icon flex-none">
                                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g opacity="0.9">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.26135 17.3176L10.3744 14.2041C10.8085 13.7699 11.3522 13.5664 11.9646 13.6085C12.577 13.6507 13.0877 13.9271 13.4581 14.4166L18.0679 20.5097C18.6893 21.331 18.611 22.4676 17.8827 23.1959L15.7252 25.3537C19.0452 28.1764 21.8211 30.9536 24.6433 34.2735L26.8013 32.1152C27.5296 31.3868 28.666 31.3086 29.4872 31.9301L35.5794 36.5405C36.0689 36.9109 36.3452 37.4216 36.3874 38.0341C36.4296 38.6466 36.226 39.1904 35.7919 39.6245L32.6783 42.7385C25.5089 49.909 0.0917082 24.4882 7.26135 17.3176ZM33.8537 6C39.4572 6 43.9997 10.2467 43.9997 15.4854C43.9997 20.724 39.4572 24.9707 33.8537 24.9707C31.9295 24.9707 30.1305 24.4699 28.5975 23.6002C27.3492 24.1528 26.0098 24.3125 24.728 24.123C25.208 23.2144 25.5656 22.2462 25.7915 21.2437C24.4847 19.647 23.7077 17.6511 23.7077 15.4854C23.7077 10.2467 28.2502 6 33.8537 6Z" stroke="#FFA920" stroke-miterlimit="22.9256" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M33.8308 20.0552V14.4344H32.5506M32.4907 20.1123H35.171M33.8308 10.7305V10.7595" stroke="#FFA920" stroke-miterlimit="22.9256" stroke-linecap="round" stroke-linejoin="round"/>
                                            </g>
                                        </svg>                                     
                                    </div>
                                    <div class="content">
                                        <p class="text-color-2">Call us:</p>
                                        <a href="tel:0123456789"><h5 class="fw-6 text-color-3">(201) 555-0124</h5></a>
                                    </div>
                                </div>
                                <!-- Logo Box -->
            ...
            <!-- Main Header -->
            <header id="header" class="main-header home2 header  header-fixed style-absolute  ">
                            ...
                            <div class="col-lg-12">
                                <div class="inner-container flex justify-space align-center">
                                                ...
                                                <ul class="navigation clearfix">
                                                    <li class="dropdown2 current"><a href="#">Home</a>
                                                        <ul>
                                                            ...
                                                            <li class="current"><a href="home02.html">Home Page 02</a></li>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="form-group-1 search-form">
                                            <input type="search" class="search-field" placeholder="Search..." value="" title="Search for" required="">
                                        </div>
                                    </div>
            ...
            <!-- End Main Header -->
                            ...
                            <div class="row">  
                                ...
                                <div class="content po-content-two">
                                    <div class="heading center">
                                        <h1 class="text-color-1 wow fadeInDown js-letters"  data-wow-delay="50ms" data-wow-duration="1000ms">Choose your home for future life</h1>
                                        <p class="fs-16 lh-24 text-color-1 fw-6">Find a variety of properties that suit you very easily, forget all difficulties in finding a residence for you</p>
                                    </div>
                                                            ...
                                                            <div class="box box-dream hv-one">
                                                                ...
                                                                <div class="content">
                                                                    ...
                                                                    <div class="days-box flex justify-space align-center">
                                                                        ...
                                                                        <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="assets/images/author/author-16.jpg" alt="images"></div>
                                                        ...
                                                        <div class="slide-item">
                                                            <div class="box box-dream hv-one">
                                                                ...
                                                                <div class="content">
                                                                    ...
                                                                    <div class="days-box flex justify-space align-center">
                                                                        <a class="compare flex align-center fw-6" href="#">Compare</a>
                                                                        <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="assets/images/author/author-17.jpg" alt="images"></div>
                                                                        <div class="days">3 years ago</div>
                                                                    </div>                                           
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="slide-item">
                                                            <div class="box box-dream hv-one">
                                                                ...
                                                                <div class="content">
                                                                    ...
                                                                    <div class="days-box flex justify-space align-center">
                                                                        <a class="compare flex align-center fw-6" href="#">Compare</a>
                                                                        <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="assets/images/author/author-18.jpg" alt="images"></div>
                                                                        <div class="days">3 years ago</div>
                                                                    </div>                                           
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="box box-dream hv-one">
                                                                <div class="image-group relative ">
                                                                    ...
                                                                    <div class="swiper-container noo carousel-2 img-style"  >    
                                                                        <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                                                        <div class="swiper-wrapper ">
                                                                            <div class="swiper-slide"><img src="assets/images/house/featured-20.jpg" alt="images"></div>
                                                        ...
                                                        <div class="box box-dream hv-one">
                                                            <div class="image-group relative ">
                                                                ...
                                                                <div class="swiper-container noo carousel-2 img-style"  >    
                                                                    <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                                                    <div class="swiper-wrapper ">
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-30.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-2.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-3.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-4.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-5.jpg" alt="images"></div>
                                                        ...
                                                        <div class="box box-dream hv-one">
                                                            <div class="image-group relative ">
                                                                ...
                                                                <div class="swiper-container noo carousel-2 img-style"  >    
                                                                    <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                                                    <div class="swiper-wrapper ">
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-29.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-2.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-3.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-4.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-5.jpg" alt="images"></div>
                                                        ...
                                                        <div class="box box-dream hv-one">
                                                            <div class="image-group relative ">
                                                                ...
                                                                <div class="swiper-container noo carousel-2 img-style"  >    
                                                                    <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                                                    <div class="swiper-wrapper ">
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-40.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-14.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-3.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-4.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-5.jpg" alt="images"></div>
                                                        ...
                                                        <div class="box box-dream hv-one">
                                                            <div class="image-group relative ">
                                                                ...
                                                                <div class="swiper-container noo carousel-2 img-style"  >    
                                                                    <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                                                    <div class="swiper-wrapper ">
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-37.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-6.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-7.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-8.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-9.jpg" alt="images"></div>
                                                        ...
                                                        <div class="box box-dream hv-one">
                                                            <div class="image-group relative ">
                                                                ...
                                                                <div class="swiper-container noo carousel-2 img-style"  >    
                                                                    <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                                                    <div class="swiper-wrapper ">
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-39.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-2.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-3.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-4.jpg" alt="images"></div>
                                                                        <div class="swiper-slide"><img src="assets/images/house/featured-5.jpg" alt="images"></div>
                        ...
                        <div class="row">                      
                            <div class="col-lg-12">
                                ...
                                <div class="swiper-container carousel-11"  >    
                                    <div class="swiper-wrapper ">
                                        <div class="swiper-slide">
                                            <div class="box">
                                                ...
                                                <div class="content">
                                                    <h3 class="link-style-3"><a href="properties-map-v1.html">Chicago</a></h3>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box">
                                                ...
                                                <div class="content">
                                                    <h3 class="link-style-3"><a href="properties-map-v1.html">New York</a></h3>
                                                    <p class="text-color-1">1570 listing</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="pagi center"><div class="swiper-pagination1" >  </div> </div>   
                ...
                <section class="flat-estate-near" >
                    <div class="container">
                        <div class="row">                      
                            <div class="col-lg-12">
                                <div class="heading-section center">
                                    <h2>Real estate near you</h2>
                                    <p class="text-color-4">Try our suggestions, here are the apartments that are most convenient for you</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="box flex align-center hv-one">
                                    <div class="images flex-none img-style s-one relative">
                                        <img class="img2" src="assets/images/img-box/estate-near-1.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="properties-map-v2.html" >California</a></h3>
                                        <p class="text-color-7">1570 listing</p>
                                        <div class="meta style">
                                            <a href="properties-map-v2.html" class="btn-button flex align-center justify-center fs-14 fw-6"><span>View all listing</span> 
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="box flex align-center hv-one">
                                    <div class="images flex-none img-style s-one relative">
                                        <img class="img2" src="assets/images/img-box/estate-near-2.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="properties-map-v2.html" >Banglore</a></h3>
                                        <p class="text-color-7">27 listing</p>
                                        <div class="meta style">
                                            <a href="properties-map-v2.html" class="btn-button flex align-center justify-center fs-14 fw-6"><span>View all listing</span> 
                                                <i class="far fa-long-arrow-alt-right fs-16"></i> 
                                            </a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="box flex align-center hv-one">
                                    <div class="images flex-none img-style s-one relative">
                                        <img class="img2" src="assets/images/img-box/estate-near-3.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="properties-map-v2.html" >New Delhi</a></h3>
                                        <p class="text-color-7">464 listing</p>
                                        <div class="meta style">
                                            <a href="properties-map-v2.html" class="btn-button flex align-center justify-center fs-14 fw-6"><span>View all listing</span> 
                                                <i class="far fa-long-arrow-alt-right fs-16"></i> 
                                            </a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="box flex align-center hv-one">
                                    <div class="images flex-none img-style s-one relative">
                                        <img class="img2" src="assets/images/img-box/estate-near-4.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="properties-map-v2.html" >New York</a></h3>
                                        <p class="text-color-7">3568 listing</p>
                                        <div class="meta style">
                                            <a href="properties-map-v2.html" class="btn-button flex align-center justify-center fs-14 fw-6"><span>View all listing</span> 
                                                <i class="far fa-long-arrow-alt-right fs-16"></i> 
                                            </a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="box flex align-center hv-one">
                                    <div class="images flex-none img-style s-one relative">
                                        <img class="img2" src="assets/images/img-box/estate-near-5.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="properties-map-v2.html" >Ohio</a></h3>
                                        <p class="text-color-7">1568 listing</p>
                                        <div class="meta style">
                                            <a href="properties-map-v2.html" class="btn-button flex align-center justify-center fs-14 fw-6"><span>View all listing</span> 
                                                <i class="far fa-long-arrow-alt-right fs-16"></i> 
                                            </a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="box flex align-center hv-one">
                                    <div class="images flex-none img-style s-one relative">
                                        <img class="img2" src="assets/images/img-box/estate-near-6.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="properties-map-v2.html" >Hong Kong</a></h3>
                                        <p class="text-color-7">741 listing</p>
                                        <div class="meta style">
                                            <a href="properties-map-v2.html" class="btn-button flex align-center justify-center fs-14 fw-6"><span>View all listing</span> 
                                                <i class="far fa-long-arrow-alt-right fs-16"></i> 
                                            </a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="box flex align-center hv-one">
                                    <div class="images flex-none img-style s-one relative">
                                        <img class="img2" src="assets/images/img-box/estate-near-7.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="properties-map-v2.html" >Berlin</a></h3>
                                        <p class="text-color-7">6985 listing</p>
                                        <div class="meta style">
                                            <a href="properties-map-v2.html" class="btn-button flex align-center justify-center fs-14 fw-6"><span>View all listing</span> 
                                                <i class="far fa-long-arrow-alt-right fs-16"></i> 
                                            </a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="box flex align-center hv-one">
                                    <div class="images flex-none img-style s-one relative">
                                        <img class="img2" src="assets/images/img-box/estate-near-8.jpg" alt="images">
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="properties-map-v2.html" >Silicon Valley</a></h3>
                                        <p class="text-color-7">925 listing</p>
                                        <div class="meta style">
                                            <a href="properties-map-v2.html" class="btn-button flex align-center justify-center fs-14 fw-6"><span>View all listing</span> 
                                                <i class="far fa-long-arrow-alt-right fs-16"></i> 
                                            </a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="box flex align-center hv-one">
                                    ...
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="properties-map-v2.html" >Brazil</a></h3>
                                        <p class="text-color-7">398 listing</p>
                                        <div class="meta style">
                                            <a href="properties-map-v2.html" class="btn-button flex align-center justify-center fs-14 fw-6"><span>View all listing</span> 
                                                <i class="far fa-long-arrow-alt-right fs-16"></i> 
                                            </a>
                ...
                <section class="tf-section flat-properties-rent wg-dream bg-1 home2 dots-style2" >
                                        ...
                                        <div class="slide-item">
                                            <div class="box box-dream flex hv-one">
                                                <div class="image-group relative  ">
                                                    ...
                                                    <span class="featured style fs-12 fw-6">For sale</span>    
                                                    <span class="icon-bookmark"><i class="far fa-bookmark"></i></span> 
                                                    <div class="swiper-container noo carousel-2 img-style " data-chat="person1">    
                                                        <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-1.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-2.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-3.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-1.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-2.jpg" alt="images"></div>
                                                        </div>
                                                        <div class="pagi2"><div class="swiper-pagination2" >  </div> </div>
                                                ...
                                                <div class="content">
                                                    <h3 class="link-style-1"><a href="property-detail-v1.html">Gorgeous Apartment Building</a> </h3>
                                                    <div class="text-address"><p class="p-12">58 Hullbrook Road, Billesley, B13 0LA</p></div>
                                                    <div class="money fs-20 fw-8 font-2 text-color-3"><a href="property-detail-v1.html">$7,500</a></div>  
                                                    <div class="icon-box">
                                                    ...
                                                    <div class="img-box flex justify-space align-center">
                                                        <div class="img-author flex align-center"><img src="assets/images/author/author-20.jpg" alt="images"><div class="fs-13 fw-6 link-style-1"><a href="#">Kathryn Murphy</a></div> </div>
                                                        <a class="icon-repeat">
                                        ...
                                        <div class="slide-item">
                                            <div class="box box-dream flex  hv-one">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="img-box flex justify-space align-center">
                                                        <div class="img-author flex align-center"><img src="assets/images/author/author-21.jpg" alt="images"><div class="fs-13 fw-6 link-style-1"><a href="#">Kathryn Murphy</a></div> </div>
                                                        <a class="icon-repeat">
                                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M5 14L2 11M2 11L5 8M2 11H11M11 2L14 5M14 5L11 8M14 5H5" stroke="#1C1C1E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                            </svg>
                                            ...
                                            <div class="box box-dream flex hv-one">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="img-box flex justify-space align-center">
                                                        ...
                                                        <div class="img-author flex align-center"><img src="assets/images/author/author-2.jpg" alt="images"><div class="fs-13 fw-6 link-style-1"><a href="#">Kathryn Murphy</a></div> </div>
                                                        <a class="icon-repeat">
                                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M5 14L2 11M2 11L5 8M2 11H11M11 2L14 5M14 5L11 8M14 5H5" stroke="#1C1C1E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                            </svg>
                    ...
                    <div class="container">
                        <div class="row">                      
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="assets/images/img-box/meet-1.jpg" alt="images"></a>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="assets/images/img-box/meet-2.jpg" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                            ...
                            <div class="col-lg-4 col-md-4 ">
                                <div class="box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="assets/images/img-box/meet-3.jpg" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                            ...
                            <div class="col-lg-12">
                                <div class="box-text flex justify-center">
                                    <p>Become an agent and get the commission you deserve. </p> <a href="contact.html" class="text-color-3 font-2 fw-7"> Contact us</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">                      
                            <div class="col-lg-5 col-md-7">
                                <div class="heading-tesi">
                                    ...
                                    <p class="text-1 text-color-4 font-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sed tristique metus proin id lorem odio</p>
                                    <div class="icon-testi"><img src="assets/images/icon/testimonial.svg" alt="images"></div>
                                    <div class="text-testi fs-20 font-2 fw-5 lh-30 relative">“ Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer vel tortor justo. Vestibulum vitae vulputate lacus. Aliquam sollicitudin mauris odio. Fusce egestas consectetur elit, eu semper ex vulputate id. “</div>
                                    <div class="author-box flex align-center">
                                        <div class="img-author"><img src="assets/images/author/author-testimonial2.jpg" alt="images"></div>
                                        <div class="content">
                            ...
                            <div class="col-lg-7 col-md-5">
                                <div class="wrap-testi flex relative">
                                    <div class="box box-1">
                                        <div class="media"><img src="assets/images/img-box/testimonial-1.jpg" alt="images"></div>
                                        <div class="media"><img src="assets/images/img-box/testimonial-2.jpg" alt="images"></div>
                                    </div>
                                    <div class="box box-2">
                                        <div class="media"><img src="assets/images/img-box/testimonial-3.jpg" alt="images"></div>
                                        <div class="media"><img src="assets/images/img-box/testimonial-4.jpg" alt="images"></div>
                                        ...
                                        <div class="slide-item">
                                            <div class="box box-dream hv-one">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="days-box flex justify-space align-center">
                                                        <a class="compare flex align-center fw-6" href="#">Compare</a>
                                                        <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="assets/images/author/author-22.jpg" alt="images"></div>
                                                        <div class="days">3 years ago</div>
                                                    </div>                                           
                                                </div>
                                            </div>
                                        ...
                                        <div class="slide-item ">
                                            <div class="box box-dream hv-one">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="days-box flex justify-space align-center">
                                                        <a class="compare flex align-center fw-6" href="#">Compare</a>
                                                        <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="assets/images/author/author-23.jpg" alt="images"></div>
                                                        <div class="days">3 years ago</div>
                                                    </div>                                           
                                                </div>
                                            </div>
                                        ...
                                        <div class="slide-item ">
                                            <div class="box box-dream hv-one">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="days-box flex justify-space align-center">
                                                        <a class="compare flex align-center fw-6" href="#">Compare</a>
                                                        <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="assets/images/author/author-24.jpg" alt="images"></div>
                                                        <div class="days">3 years ago</div>
                                                    </div>                                           
                                                </div>
                                            </div>
                                        ...
                                        <div class="slide-item ">
                                            <div class="box box-dream hv-one">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="days-box flex justify-space align-center">
                                                        <a class="compare flex align-center fw-6" href="#">Compare</a>
                                                        <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="assets/images/author/author-25.jpg" alt="images"></div>
                                                        <div class="days">3 years ago</div>
                                                    </div>                                           
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="box hover-img">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="meta">
                                            <a href="blog-detail.html" class="btn-button flex align-center fs-13 fw-6 text-color-3"><span>Read more </span> 
           ...
           <footer id="footer" class="clearfix home2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="widget widget-info">
                            ...
                            <h5 class="text-color-2">2118 Thornridge Cir. Syracuse, Connecticut 35624</h5>
                            <p class="sub-title">Branch:</p>
                            <p class="text-1 text-color-2">3891 Ranchview Dr. Richardson, California 62639</p>
                            <p class="text-2 text-color-2">3517 W. Gray St. Utica, Pennsylvania 57867</p>
                        </div>
                    </div>
                        ...
                        <div class="widget widget-menu style-2">
                            ...
                            <div class="box-icon flex align-center">
                                <div class="icon flex-none">
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g opacity="0.3">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.26135 17.3176L10.3744 14.2041C10.8085 13.7699 11.3522 13.5664 11.9646 13.6085C12.577 13.6507 13.0877 13.9271 13.4581 14.4166L18.0679 20.5097C18.6893 21.331 18.611 22.4676 17.8827 23.1959L15.7252 25.3537C19.0452 28.1764 21.8211 30.9536 24.6433 34.2735L26.8013 32.1152C27.5296 31.3868 28.666 31.3086 29.4872 31.9301L35.5794 36.5405C36.0689 36.9109 36.3452 37.4216 36.3874 38.0341C36.4296 38.6466 36.226 39.1904 35.7919 39.6245L32.6783 42.7385C25.5089 49.909 0.0917082 24.4882 7.26135 17.3176ZM33.8537 6C39.4572 6 43.9997 10.2467 43.9997 15.4854C43.9997 20.724 39.4572 24.9707 33.8537 24.9707C31.9295 24.9707 30.1305 24.4699 28.5975 23.6002C27.3492 24.1528 26.0098 24.3125 24.728 24.123C25.208 23.2144 25.5656 22.2462 25.7915 21.2437C24.4847 19.647 23.7077 17.6511 23.7077 15.4854C23.7077 10.2467 28.2502 6 33.8537 6Z" stroke="#1C1C1E" stroke-miterlimit="22.9256" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M33.8308 20.0552V14.4344H32.5506M32.4907 20.1123H35.171M33.8308 10.7305V10.7595" stroke="#1C1C1E" stroke-miterlimit="22.9256" stroke-linecap="round" stroke-linejoin="round"/>
                                        </g>
                                    </svg>
                                </div>
                                <div class="content">
                            ...
                            <div class="box-icon flex align-center">
                                <div class="icon flex-none">
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M27.1876 21.5002C27.1876 23.3585 26.0473 24.75 24.6819 24.75C23.3166 24.75 22.1093 23.3778 22.1093 21.5195C22.1093 19.6614 23.3837 18.4233 24.7491 18.4233C26.1143 18.4233 27.1876 19.6421 27.1876 21.5002Z" stroke="#1C1C1E" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M24.868 27.8945C22.1524 27.8194 19.6763 25.9815 18.9411 23.1859C18.0925 19.9591 19.9485 16.5889 23.1278 15.5769C26.4904 14.5065 30.0664 16.3982 31.0824 19.7644C31.4419 21.1114 31.2321 22.2832 30.7557 23.481C30.5668 23.956 29.9439 25.0679 28.5582 25.0679C27.8016 25.0679 27.1709 24.3429 27.175 23.5078L27.2024 17.9739" stroke="#1C1C1E" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M31.0829 19.7649C31.4425 21.1118 31.2326 22.2836 30.7562 23.4814" stroke="#1C1C1E" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M30.366 11.5664L24.9999 7.11327L19.6339 11.5664" stroke="#1C1C1E" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M12.3828 17.5839L7.11328 21.957V42.8867H42.8868V21.957L37.6173 17.5839" stroke="#1C1C1E" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M25 33.0898L37.6173 25.2368V11.5663H12.3828V25.2368L25 33.0898Z" stroke="#1C1aboutvideoC1E" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M42.8868 21.957L25.0001 33.0898L7.11328 21.957V42.8867H42.8868V21.957Z" stroke="#1C1C1E" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        </g>
                                        </g>
                                    </svg>                                     
                                </div>
                                <div class="content">
                                    <p>Email:</p>
                                    <a href="mailto:Realestatecp@gmail.com"><h5 class="fw-4 text-color-2">Realestatecp@gmail.com</h5></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="widget widget-menu widget-form">
                            ...
                            <form method="post" class="comment-form form-submit" action="#" accept-charset="utf-8">
                                <p class="font-2 text-color-2">Sign up to receive the latest articles</p>  
                                ...
                                <label class="flex">
                                    ...
                                    <span class="fs-12 text-color-2 lh-18">I have read and agree to the terms & conditions</span>
                                </label>
                            </form>
                        </div>
                    </div>
            ...
            <div class="widget-logo-footer home2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="wrap-logo flex align-center justify-space">
                                <div class="logo-footer style2 box-1" id="logo-footer">
                                    <a href="index.html">
                                        <img src="assets/images/logo/logo@2x.png" alt="" width="197" height="48">
                                    </a>
                                </div>
            ...
            <div class="widget-bottom-footer home2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="title-bottom center"> Copyright © 2023. Designed & Developed by <a href="https://themeforest.net/user/themesflat/portfolio" class="text-color-2 fw-5">Themesflat.</a> </div>
                        </div>
                    </div>
                </div>
            </div>
