...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                    ...
                                                    <li class="dropdown2"><a href="#">Property</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2"><a href="#">Property Map</a>
                                                                <ul>
                                                                    <li><a href="properties-map-v1.html">Property Property Half Map V1</a></li>
                                                                    <li><a href="properties-map-v2.html">Property Property Half Map V2</a></li>
                                                                    <li><a href="properties-map-v3.html">Property Property Half Map V3</a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Agents</a>
                                                                <ul>
                                                                    ...
                                                                    <li class="current"><a href="agents-sidebar-v1.html">Agents Sidebar V1</a></li>
            ...
            <section class="tf-section2 flat-agent-sidebar flat-property flat-meet style" >
                <div class="container">
                    <div class="row flex">                      
                        <div class="col-lg-8">
                            <div class="post">
                            <div class="category-filter flex align-center justify-space">
                                <div class="box-1 ">
                                    <div class="heading-listing fs-30 lh-45 fw-7">Agents</div>
                                </div>
                                <div class="box-2 flex">
                                    ...
                                    <div class="wd-find-select flex">
                                        <div class="group-select">
                                            <div class="nice-select" tabindex="0"><span class="current">Sort By Name (A->Z)</span>
                                                <ul class="list style">                                                          
                            ...
                            <div class="wrap-list form-wg flex flex-wrap">
                                <div class="box wg-box hover-img">
                                ...
                                <div class="box wg-box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="assets/images/img-box/meet-7.jpg" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                ...
                                <div class="box wg-box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="assets/images/img-box/meet-8.jpg" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                ...
                                <div class="box wg-box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="assets/images/img-box/meet-9.jpg" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                ...
                                <div class="box wg-box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="assets/images/img-box/meet-10.jpg" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                ...
                                <div class="box wg-box hover-img">
                                    <div class="images relative">
                                        <a href="agents-detail.html"><img src="assets/images/img-box/meet-11.jpg" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                ...
                                <div class="box wg-box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="assets/images/img-box/meet-12.jpg" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                            ...
                            <div class="themesflat-pagination clearfix center style2">
                                <ul>
