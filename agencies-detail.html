...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                ...
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Page</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Agencies</a>
                                                                <ul>
                                                                    <li><a href="agencies.html">Agencies</a></li>
                                                                    <li class="current"><a href="agencies-detail.html">Agencies Detail</a></li>
            ...
            <section class="flat-agencies-detail wg-tabs " >
                <div class="container">
                    <div class="row flex">                      
                        <div class="col-lg-8">
                            <div class="post">
                                ...
                                <div class="box-avatar flex">
                                    <div class="avatar flex-none">
                                        <img class="img-border" src="assets/images/img-box/agencies-detail-avatar.jpg" alt="images">
                                    </div>
                                    <div class="content ">
                                        <div class="title-avatar fs-30 fw-7 lh-45">Lorem House</div>
                                        <p class="icon-p text-color-4">2118 Thornridge Cir. Syracuse, Connecticut 35624</p>
                                    </div>
                                </div>
                                <div class="wrap-description">
                                    <h3 class="titles title-1">Contact Infomation</h3>
                                    <ul class="inner flex">
                                        <li class="one fw-6">Listing:</li>
                                        <li class="two">7.328</li>
                                        <li class="one fw-6">Hotline:</li>
                                        <li class="two"><a href="tel:0123456789">+7-445-556-8337</a></li>
                                        <li class="one fw-6">Phone:</li>
                                        <li class="two"><a href="tel:0123456789">+7-445-556-8337</a></li>
                                        <li class="one fw-6">Fax:</li>
                                        <li class="two">+7-445-556-8337</li>
                                        <li class="one fw-6">Email:</li>
                                        <li class="two"><a href="mailto:loremhouse@gmail.com">loremhouse@gmail.com</a></li>
                                    </ul>
                                    <div class="box-text">
                                        <h3 class="titles title-2">About Lorem House</h3>
                                    ...
                                    <div class="box-map">
                                        <h3 class="titles title-2">Location</h3>
                            ...
                            <div class="flat-tabs">
                                ...
                                <div class="content-tab">
                                    <div class="content-inner tab-content wg-dream ">   
                                        <div class="wrap-item form-wg flex flex-wrap">
                                            <!-- col 1 -->
                                            <div class="box box-dream hv-one wg-box">
                                                    ...
                                                    <div class="form-group-2 form-style2">
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span class="current">All categories</span>
                                                                <ul class="list style">    
                                                                    <li data-value class="option selected">All categories</li>                                                      
                                                                    <li data-value="House" class="option">House</li>
                                                                    <li data-value="Villa" class="option">Villa</li>
                                                                    <li data-value="smarrt-home" class="option "> Smart home</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
