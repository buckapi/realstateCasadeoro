                                                ...
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Page</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Agents</a>
                                                                <ul>
                                                                    <li><a href="agents.html">Agents</a></li>
                                                                    <li class="current"><a href="agents-detail.html">Agents Details</a></li>
                    ...
                    <div class="row flex">                      
                        <div class="col-lg-8">
                            ...
                            <div class="box flex ">
                                ...
                                <div class="content ">
                                    <div class="titles fs-22 fw-7 lh-33">Cameron Williamson</div>
                                    <div class="sub-text flex"><p class="">Company Agent at </p><span class="fw-7 font-2 text-color-2"> Themesflat</span></div>
                                    <div class="icon-group">
                                        <div class="icon-phone link-style-1"><a href="tel:0123456789" class=" fw-7 font-2 text-color-3">+7-445-556-8337</a></div>
                                        <div class="icon-email"><a href="mailto:darlenerobertson@gmail.com" class="font-2 ">cameronwilliamson@gmail.com</a></div>
                                        <div class="icon-map">1901 Thornridge Cir. Shiloh, Hawaii 81063</div>
                                    </div>
                                    <div class="icon-social-wg">
                            ...
                            <div class="box-text">
                                <h3 class="title-">About Cameron Williamson</h3>
                                <p class="text-1 text-color-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam risus leo, blandit vitae diam a, vestibulum viverra nisi. 
                            ...
                            <div class="flat-tabs">
                                <div class="box-tab">
                                    <ul class="menu-tab tab-title flex ">
                                        <li class="item-title active">
                                            <h3 class="inner">For rent</h3>
                                        </li>
                                        <li class="item-title style">
                                            <h3 class="inner">For sale </h3>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="content-tab">
                                    <div class="content-inner tab-content">   
                                        <div class="wrap-item wg-dream flat-properties-rent">
                                            <div class="box box-dream flex hv-one ">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container noo carousel-2 img-style" >    
                                                        ...
                                                        <div class="swiper-wrapper ">
                                                            ...
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-5.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-1.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-4.jpg" alt="images"></div>
                                                        </div>
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="text-address"><p class="p-12">58 Hullbrook Road, Billesley, B13...</p></div>
                                                    ...
                                                    <div class="img-box flex justify-space align-center">
                                                        ...
                                                        <div class="img-author flex align-center"><img src="assets/images/author/author-list-1.jpg" alt="images"><div class="fs-13 fw-6 link-style-1"><a href="#">Kathryn Murphy</a></div> </div>
                                                        <a class="icon-repeat">
                                            ...
                                            <div class="box box-dream flex hv-one ">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container noo carousel-2 img-style" >    
                                                        <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-6.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-7.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-13.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-15.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-12.jpg" alt="images"></div>
                                                        </div>
                                                        <div class="pagi2"><div class="swiper-pagination2" >  </div> </div>
                                                        <div class="swiper-button-next2 "><i class="fal fa-arrow-right"></i></div>
                                                        <div class="swiper-button-prev2 "><i class="fal fa-arrow-left"></i> </div>                                        
                                                ...
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container noo carousel-2 img-style" >    
                                                        ...
                                                        <div class="swiper-wrapper ">
                                                            ...
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-12.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-13.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-11.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-12.jpg" alt="images"></div>
                                                        </div>
                                                        <div class="pagi2"><div class="swiper-pagination2" >  </div> </div>
                                                        <div class="swiper-button-next2 "><i class="fal fa-arrow-right"></i></div>
                                            ...
                                            <div class="box box-dream flex hv-one ">
                                                <div class="image-group relative  ">
                                                    ...
                                                    <div class="swiper-container noo carousel-2 img-style" >    
                                                        <a href="property-detail-v1.html" class="icon-plus"><img src="assets/images/icon/plus.svg" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-9.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-2.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-3.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-1.jpg" alt="images"></div>
                                                            <div class="swiper-slide"><img src="assets/images/house/properties-rent-2.jpg" alt="images"></div>
                            ...
                            <div class="group-button-view ">
                                <a class="sc-button btn-icon2 btn-1 one btn-svg center" href="properties-grid.html">
                                    <span>View all my listing</span>
                                    <svg width="18" height="10" viewBox="0 0 14 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.5 1L13 3.5M13 3.5L10.5 6M13 3.5H1" stroke="#FFA920" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </a>
                            </div> 
                         </div>
                                                ...
                                                <form method="post">
                                                    <div class="wd-find-select ">
                                                        ...
                                                        <div class="form-group-1 search-form form-style2 relative">
                                                            ...
                                                            <input type="search" class="search-field" placeholder="Agent’s name" value="" name="s" title="Search for" required="">
                                                        </div>
                                                            
                                                        <div class="form-group-2 form-style2">
                                                            <div class="group-select">
                                                                <div class="nice-select" tabindex="0"><span class="current">All categories</span>
                                                                    <ul class="list">                                                          
                                                                        ...
                                                                        <li data-value="Single family home" class="option selected">Single family home</li>
                                                                        <li data-value="Multi family home" class="option">Multi family home</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-3 form-style2">
                                                            <div class="group-select">
                                                                <div class="nice-select" tabindex="0"><span class="current">Location</span>
                                                                    <ul class="list">                                                          
                                                                        ...
                                                                        <li data-value="England" class="option selected">England</li>                                                                  
                                                                        <li data-value="VietNam" class="option">VietNam</li>
                                                                    </ul>
                                                                </div>
                                                            </div>                                                    
                                                        </div>
                                                        <div class="button-search sc-btn-top center">
