                    ...
                    <div class="row">    
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                ...
                                <div class="text-box flex justify-center flex-wrap"><span class="text-color-4">Quick answers to questions you may have. Can't find what you're looking for? Check out our </span><a class="fw-7 font-2 text-color-4 text-line" href="#"> full documentation</a></div>
                            </div>
                        </div>                  
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    ...
                                    <div class="fw-6">Vivamus at orci ut neque tincidunt convallis.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Nam nec justo congue, gravida velit et, viverra nibh.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Cras ac purus sed lectus volutpat feugiat in et nunc.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Fusce at arcu dapibus, fermentum diam sed, pretium mi.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Nulla facilisis lorem vel turpis hendrerit faucibus.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Pellentesque faucibus ante id nunc molestie elementum.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Phasellus luctus nibh vitae leo malesuada tempus.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Vestibulum malesuada eros et nisi ornare feugiat.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Nulla non turpis non diam tincidunt convallis.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Curabitur eget risus venenatis risus consectetur tristique.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Mauris ultrices nibh ac augue porta iaculis.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="flat-toggle ">
                                <div class="toggle-title flex align-center">
                                    <i class="fal fa-question-circle"></i>
                                    <div class="fw-6">Etiam nec dolor non nunc luctus sodales.</div> 
                                    <div class="btn-toggle"></div>
                                </div>
                                <div class="toggle-content section-desc">
                                    <p class="texts text-color-2">Proin sed tellus porttitor, varius mauris vitae, tincidunt augue. Sed consectetur magna elit, sit amet faucibus tortor sodales vitae. Maecenas quis arcu est. Nam sit amet neque vestibulum, fringilla elit sit amet, volutpat nunc.</p>
                        ...
                        <div class="col-lg-12">
                            <div class="wrap-author center">
                                <div class="images"><img src="assets/images/author/author-faq.jpg" alt="images"></div>
                                <div class="content">
                                    <h4>Still have question?</h4>
                                    <div><span>Can't find what you're looking for? Please </span> <a class="text-color-3 font-2 fw-7" href="#"> chat to our friendly team.</a></div>
                                </div>
                                <div class="button-faq">
                                    <a class="sc-button center" href="#">
                                        <span>Documentation</span>
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.125 3.5H2.9375C2.48995 3.5 2.06072 3.67779 1.74426 3.99426C1.42779 4.31073 1.25 4.73995 1.25 5.1875V13.0625C1.25 13.5101 1.42779 13.9393 1.74426 14.2557C2.06072 14.5722 2.48995 14.75 2.9375 14.75H10.8125C11.2601 14.75 11.6893 14.5722 12.0057 14.2557C12.3222 13.9393 12.5 13.5101 12.5 13.0625V6.875M4.625 11.375L14.75 1.25M14.75 1.25H10.8125M14.75 1.25V5.1875" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>                              
                                    </a>
                                    <a class="sc-button center btn-1" href="#">                             
