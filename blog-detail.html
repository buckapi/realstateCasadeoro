                    ...
                    <div class="row flex">                      
                        <div class="col-lg-8">
                            <div class="post">
                                ...
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">The average contract interest rate for 30-year fixed-rate mortgages with conforming loan balances ($726,200 or less) decreased to 6.40% from 6.45%, with points falling to 0.59 from 0.62 (including the origination fee) for loans with a 20% down payment. It had been over 7% just a month ago.</p>
                                <p class="texts-2 fs-16 font-2 lh-29 text-color-2">Mortgage applications to purchase a home, however, dropped 4% last week compared with the previous week, according to the Mortgage Bankers Association’s seasonally adjusted index. Demand was 35% lower than the same week one year ago.</p>
                                <div class="text-box">
                                    <p class="texts fs-16 font-2 lh-29 text-color-2">“Spring has arrived, but the housing market is missing the customary burst in listings and purchase activity that typically mark the season. After four weeks of increasing purchase application activity, volume declined a bit this week even with another small drop in mortgage rates,” said Mike Fratantoni, MBA’s chief economist.</p>
                                </div>
