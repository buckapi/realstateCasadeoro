...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                ...
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Blog</a>
                                                        <ul>
                                                            ...
                                                            <li class="current"><a href="blog-grid.html">Blog Grid</a></li>
            ...
            <section class="tf-section2 flat-blog-grid flat-property style3" >
                <div class="container">
                    <div class="row flex">                      
                        <div class="col-lg-8">
                            <div class="post">
                            <div class="category-filter flex  justify-space">
                                <div class="box-1 ">
                                    <div class="heading-listing fs-30 lh-45 fw-7">Blog Grid</div>
                                </div>
                            ...
                            <div class="flat-blog">
                                ...
                                <div class="wrap-blog form-wg flex flex-wrap">
                                    <div class="box hover-img wg-box">
