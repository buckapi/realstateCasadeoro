...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                    ...
                    <div class="row">                      
                        <div class="col-lg-6 col-md-7">
                            <div class="heading-section">
                                ...
                                <p class="text-color-">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sed tristique metus proin id lorem odio</p>
                            </div>
                            <div class="wrap-info">
                                ...
                                <div class="box-info flex align-center">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="tel:0123456789" ><h4 class="fw-8 font-2 fs-30 text-color-3 lh-37">314-555-0123</h4></a>
                                    </div>
                                </div>
                                <div class="box-info flex align-center">
                                    <div class="icon-info">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="info:hellosupport@gmail.com"><h4 class="fw-4 text-color-3">hellosupport@gmail.com</h4></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="flat-brand tf-section center page-contact relative" ><div class="overlay"></div>
                <div class="container">
                    <div class="row">                      
                        <div class="col-lg-12">
