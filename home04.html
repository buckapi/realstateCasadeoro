    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                ...
                                                <ul class="navigation clearfix">
                                                    <li class="dropdown2 current"><a href="#">Home</a>
                                                        <ul>
                                                            ...
                                                            <li class="current"><a href="home04.html">Home Page 04</a></li>
            ...
            <!-- End Main Header -->
                    ...
                    <div class="slider-item">
                        <div class="container  relative">
                            <div class="row">    
                                <div class="col-lg-7">
                                    <div class="heading">
                                        <h1 class="text-color-1 wow fadeInUp js-letters"  data-wow-delay="0ms" data-wow-duration="1000ms">Choose your home for future life</h1>
                                                        ...
                                                        <form method="post">                        
                                                            <div class="wd-find-select">
                                                                ...
                                                                <div class="form-group flex">
                                                                    <a class="sc-button icon-filter2 btn-1 btn-2 form-style center pull-right">
                                                                        <span>Filters</span>
                                ...
                                <div class="swiper-container carousel-8"  >    
                                    <div class="swiper-wrapper ">
                                        <div class="swiper-slide ">
                                            <div class="box center hv-one">
                                                ...
                                                <div class="content link-style-1" >
                                                    <a href="properties-map-v1.html"><h3>Chile</h3></a>
                                                    <p class="text-color-2">1570 listing</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="box center hv-one">
                                                <div class="images img-style s-one relative">
                                                    <img class="img2" src="assets/images/img-box/explore-2.jpg" alt="images">
                                                </div>
                                                <div class="content link-style-1">
                                                    <a href="properties-map-v1.html" class="link-style-2"><h3>Banglore</h3></a>
                                                    <p class="text-color-2">1570 listing</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="box center hv-one">
                                                <div class="images img-style s-one relative">
                                                    <img class="img2" src="assets/images/img-box/explore-3.jpg" alt="images">
                                                </div>
                                                <div class="content link-style-1">
                                                    <a href="properties-map-v1.html" ><h3>New Delhi</h3></a>
                                                    <p class="text-color-2">1570 listing</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="box center hv-one">
                                                <div class="images img-style s-one relative">
                                                    <img class="img2" src="assets/images/img-box/explore-4.jpg" alt="images">
                                                </div>
                                                <div class="content link-style-1">
                                                    <a href="properties-map-v1.html" ><h3>Berlin</h3></a>
                                                    <p class="text-color-2">1570 listing</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="box center hv-one">
                                                <div class="images img-style s-one relative">
                                                    <img class="img2" src="assets/images/img-box/explore-5.jpg" alt="images">
                                                </div>
                                                <div class="content link-style-1">
                                                    <a href="properties-map-v1.html"><h3>California</h3></a>
                                                    <p class="text-color-2">1570 listing</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="box center hv-one">
                                                <div class="images img-style s-one relative">
                                                    <img class="img2" src="assets/images/img-box/explore-6.jpg" alt="images">
                                                </div>
                                                <div class="content link-style-1">
                                                    <a href="properties-map-v1.html"><h3>Brazil</h3></a>
                                                    <p class="text-color-2">1570 listing</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <section class="flat-search-today" >
                    <div class="container-fuild">
                        <div class="row"> 
                            ...
                            <div class="col-lg-6">
                                <div class="wrap-search-today">
                                    <div class="heading-section">
                                        <h2>Search for your dream home or increase your investment opportunity today</h2>
                                        <p class="font-2 text-color-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sed tristique metus proin id lorem odio</p>
                                    </div>
                                    <div class="swiper-container2 carousel-9" > 
                                        <div class="swiper-wrapper ">
                                            <div class="swiper-slide">
                                                <div class="box hover-img">
                                                    <div class="images img-style">
                                                        <a href="agents-detail.html"><img src="assets/images/img-box/search-today-1.jpg" alt="images"></a>
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <p class="text-color-2 fs-12">Realtor</p>
                                                        <div class="meta">
                                                            <a href="agents-detail.html" class="btn-button flex align-center fw-6 text-color-3"><span>Contact seller</span> 
                                            ...
                                            <div class="swiper-slide">
                                                <div class="box hover-img">
                                                    <div class="images img-style">
                                                        <a href="agents-detail.html"><img src="assets/images/img-box/search-today-2.jpg" alt="images"></a>
                                                        <div class="icon-socials">
                                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                        ...
                                        <div class="pagi style"><div class="swiper-pagination1" >  </div> </div>  
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="box flex">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="meta style">
                                                <a href="#" class="btn-button flex align-center fs-13 fw-6 text-color-2"><span>See all listings</span> 
                                                    <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M0.875 6H12.125M12.125 6L7.0625 0.9375M12.125 6L7.0625 11.0625" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </svg> 
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="container">
                        <div class="row">                      
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="box hover-img">
                                    <div class="images img-style relative ">
                                        <a href="blog-detail.html"><img src="assets/images/img-box/blog-2.jpg" alt="images"></a>
                                        <div class="sub-box flex align-center fs-13 fw-6">
                                            <div class="title-1">April</div><a class="title-2 text-color-3">Housing</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="box hover-img">
                                    <div class="images img-style relative ">
                                        <a href="blog-detail.html"><img src="assets/images/img-box/blog-3.jpg" alt="images"></a>
                                        <div class="sub-box flex align-center fs-13 fw-6">
                                            <div class="title-1">April</div><a class="title-2 text-color-3">Housing</a>
                                        </div>
                                    </div>
