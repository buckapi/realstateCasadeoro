...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Page</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Agents</a>
                                                                <ul>
                                                                    <li class="current"><a href="agents.html">Agents</a></li>
            ...
            <section class="tf-section2 flat-agent flat-property page style" >
                <div class="container">
                    <div class="row flex">                      
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="box hover-img">
                                ...
                                <div class="content ">
                                    <h3 class="link-style-1"><a href="agencies-detail.html">Darlene Robertson</a></h3>
                                    <p class="">Realtor</p>
                                    <div class="icon-group">
                                        <div class="icon-phone"><a href="tel:0123456789" class=" fw-7 font-2">+7-445-556-8337</a></div>
