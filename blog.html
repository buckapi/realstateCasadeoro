                                            ...
                                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Blog</a>
                                                        <ul>
                                                            <li class="current"><a href="blog.html">Blog List</a></li>
                    ...
                    <div class="row flex">                      
                        <div class="col-lg-8">
                            ...
                            <div class="category-filter flex  justify-space">
                                <div class="box-1 ">
                                    <div class="heading-listing fs-30 lh-45 fw-7">Blog List</div>
                                </div>
                            ...
                            <div class="flat-blog">
                                <div class="box-heading ">
                                    ...
                                    <div class="contents center">
                                        <div class="title-heading fs-30 fw-7 lh-45">Real estate shifts: Prices and sales trending down in two different spheres</div>
                                        <h4 class="fw-4">Hosted by Brian Sullivan, “Last Call” is a fast-paced, entertaining business show that explores the intersection of money, culture and policy. Tune in Monday through Friday at 7 p.m. ET on...</h4>
                                    </div>
                                </div>
                                <div class="wrap-blog ">
                                    <div class="box hover-img flex">
                                        <div class="images img-style relative flex-none">
                                            ...
                                            <div class="sub-box flex align-center justify-space fs-13 fw-6">
                                                <div class="title-1">January 30</div><a class="title-2 text-color-3">Housing</a>
                                            </div>
                                        </div>
                                        <div class="content">
                                            <h3><a href="blog-detail.html">We are hiring ‘moderately,’ says Compass CEO</a></h3>
                                            <p class="text-color-2">Hosted by Brian Sullivan, “Last Call” is a fast-paced, entertaining business show that explores the intersection of money...</p>
                                            <div class="meta">
