...
<body class="body  ">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                    ...
                                                    <li class="dropdown2 current"><a href="#">Page</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2 current"><a href="#">Agencies</a>
                                                                <ul>
                                                                    <li class="current"><a href="agencies.html">Agencies</a></li>
            ...
            <section class="tf-section2 flat-agencies flat-property style2" >
                <div class="container">
                    <div class="row flex">                      
                        <div class="col-lg-12">
                            <div class="category-filter flex justify-space">
                                ...
                                <div class="box-2 flex">
                                    <div class="form-group-1 search-group">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="box box-agencies hover-img2 ">
                                <div class="images relative img-style2">
                                    <img class="img2" src="assets/images/img-box/agencies-9.jpg" alt="images">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="box box-agencies hover-img2 ">
                                <div class="images relative img-style2">
                                    <img class="img2" src="assets/images/img-box/agencies-10.jpg" alt="images">
                                </div>
                                <div class="icon-brand">
                        ...
                        <div class="col-lg-12">
                            <div class="themesflat-pagination clearfix center style3">
                                <ul>
